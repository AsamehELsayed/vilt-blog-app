  ...
  <Userlayout>
    <div class="container mx-auto pt-10 flex flex-col">
      <Link
        ...
        class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-40 text-center mx-auto"
      >Create post</Link>
      <h1 class="text-5xl font-bold mb-6 pl-16">Posts</h1>
      <div class="grid md:grid-cols-3 justify-items-center sm:grid-cols-1">
        <div
          v-for="post in posts"
          :key="post.id"
